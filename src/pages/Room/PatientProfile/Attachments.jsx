...
// import {  Modal,TextField,Box,Button, CardActions } from "@mui/material";
...
//     if (title.trim() === "") {
//       // Swal.fire("Please provide a title for the image!");
...
//         await handleImageUpload(patientId, title, file);
//       }
...
//     const newImage = { id: imageId, title: title, url: downloadURL };
//     images.push(newImage);
//     await patientRef.set({ images }, { merge: true });
  
//     // update the patientData state with the new image
//     setPatientData({ ...patientData.data(), images: [...images] });
...
//   //   try {
//   //     const patientRef = firebase.firestore().collection("patients").doc(`pat3`);
//   //    const db =  await patientRef.update({
//   //       "images.id": firebase.firestore.FieldValue.arrayRemove(ID),
//   //     });
//   //     console.log("Image deleted successfully!");
//   //     console.log("Image deleted successfully!",db);
...
//   const deletePatientData = async (patientId, imageId) => {
//     console.log("first","dele")
//     // try {
//     //   const patientRef = firebase.firestore().collection("patients").doc(patientId);
//     //   const patientDoc = await patientRef.get();
//     //   if (patientDoc.exists) {
//     //     const updateResult = await patientRef.update({
...
//     //   console.error("Error deleting image:", error);
//     // }
//     // const querySnapshot = await firebase.firestore().collection("patients").get();
//     // if (querySnapshot.empty) {
//     //   console.log("No documents found in the 'patients' collection.");
//     // } else {
//     //   console.log(`Found ${querySnapshot.size} documents in the 'patients' collection.`);
//     // }
//   };
...
//                         <CardActions>
//                           <Button
//                             onClick={() => deletePatientData(image.id.toString(), image.url)}
//                             size="small"
//                             color="primary"
//                           >
//                             Delete
