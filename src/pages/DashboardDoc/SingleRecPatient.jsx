...
const SingleRecPatient = (props) => {
  const  {id}  = useParams();
  const currentItem = RecentSinglePatientData.filter(item => item.id === id)[0];
...
const Table = (props) => {
  ...
  return (
       ...
       <div className='Container' style={{display:'flex'}}>
        <div className="left-profile" style={{flex:1}}>
          <Navbar/>
        </div>
       
       <div className="right-profile" style={{flex:4}}>
           <Scrollbars>
               <SubTopbar/>
               <div className="Profile">
                   <div className="profile-left">
                       ...
                       <div >
                           ...
                           <span>Patient Id - {currentItem.id}</span>
                   ...
                   <div className="profile-right">
                       ...
                       <div className='profile-rightspan'>
                           <span className='span1'>Age:- {currentItem.age}years</span>
                           <span>Height:- 5.5ft</span>
                       </div>
                       <div className='profile-rightspan'>
                           <span className='span1'>Gender:- {currentItem.gender}</span>
...
export default SingleRecPatient;
      ...
      //     </p>
      //     <div style={{flexDirectoion:'column'}} >

      //     <span>{currentItem.name}</span><br />
      //     <span>{currentItem.name}</span><br />
